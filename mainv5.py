...
genai.configure(api_key="AQ.Ab8RN6IxGPuOU3p3kIjC0md1l2nl2ahRwf2D_hNUPHn6jWgwJQ")
...
while True:
    ...
    image_combined=cv2.addWeighted(img,0.7,canvas,0.3,0,0)
